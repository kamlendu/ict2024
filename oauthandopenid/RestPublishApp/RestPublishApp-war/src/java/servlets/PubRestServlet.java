   ...
   // private TokenProvider tokenProvider;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     //ClientRequest cr = new ClientRequest();
        ...
        //String groups = openidContext.getCallerGroups();
     // System.out.println("idtoken="+openidContext.getIdentityToken());
     System.out.println("json="+json.getString("email"));
   if(!json.getString("email").equals("kspandey@vnsgu.ac.in")){
           response.sendError(HttpServletResponse.SC_UNAUTHORIZED, "Access denied.");
   }
   else {
       
       //String token= openidContext.getAccessToken().getToken();
